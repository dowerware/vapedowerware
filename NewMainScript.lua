...
local function install_profiles(num)
    ...
    local function vapeGithubRequest(scripturl)
        if not isfile('vape/'..scripturl) then
            local suc, res = pcall(function() return game:HttpGet('https://raw.githubusercontent.com/dowerware/dowerwareprofiles/main/'..scripturl, true) end)
    ...
    task.spawn(function()
        local res1
        if num == 1 then
            res1 = "https://api.github.com/repos/dowerware/dowerwareprofiles/contents/Profiles"
        elseif num == 2 then
            res1 = "https://api.github.com/repos/dowerware/dowerwareprofiles/contents/ClosetProfiles"
        end
...
if not shared.VapeDeveloper then 
	local commit = "main"
	for i,v in pairs(game:HttpGet("https://github.com/dowerware/vapedowerware"):split("\n")) do 
...
local function vapeGithubRequest(scripturl, isImportant)
    ...
    local suc, res
    suc, res = pcall(function() return game:HttpGet("https://raw.githubusercontent.com/dowerware/vapedowerware/"..readfile("vape/commithash2.txt").."/"..scripturl, true) end)
